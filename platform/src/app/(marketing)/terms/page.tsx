    ...
    <div className="bg-slate-50">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="mt-3 text-slate-600">Last updated: {lastUpdated}</p>
        </div>
        ...
        <div className="prose max-w-none space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              <a href="mailto:support@drawintheair.app" className="text-orange-600 hover:text-orange-700">
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              <a href="mailto:schools@drawintheair.app" className="text-orange-600 hover:text-orange-700">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-900">7. Camera and Microphone</h2>
            <p className="text-slate-700 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              <a href="mailto:legal@drawintheair.app" className="text-orange-600 hover:text-orange-700">
        ...
        {/* Footer Links */}
        <div className="mt-12 pt-8 border-t border-slate-200 flex flex-wrap gap-4 text-sm text-slate-600">

    ...
    <div className="bg-slate-50">
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">Privacy at the Heart of Learning</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-6">
            {/* Teacher Data */}
            <div className="rounded-lg border border-slate-200 bg-orange-50 p-6">
              <h3 className="text-lg font-semibold text-orange-700 mb-3">For Teachers (Account Holders)</h3>
            ...
            <div className="rounded-lg border border-slate-200 bg-blue-50 p-6">
              <h3 className="text-lg font-semibold text-blue-700 mb-3">For Students</h3>
              <ul className="space-y-2 text-slate-700">
                <li className="flex gap-3">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">What We Explicitly Do NOT Collect</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">How We Use the Camera</h2>
          ...
          <div className="space-y-4 text-slate-700 leading-relaxed">
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-100 p-6 space-y-3">
              <p className="font-semibold text-slate-900">No frames are transmitted to our servers.</p>
              <p>
              ...
              <p className="font-semibold text-slate-900">Teachers control camera access.</p>
              <p>
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">How Long We Keep Data</h2>

          <div className="space-y-4">
            <div className="rounded-lg border border-slate-200 bg-slate-100 p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Teacher Data</h3>
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-100 p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Student Session Data</h3>
              <p className="text-slate-700">
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-100 p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Camera Frames</h3>
              <p className="text-slate-700">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">COPPA Compliance (US)</h2>

          <div className="rounded-lg border border-slate-200 bg-slate-100 p-6 space-y-3 text-slate-700">
            <p>
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">GDPR Rights for Teachers</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="rounded-lg border border-slate-200 bg-slate-100 p-4">
                <h3 className="font-semibold text-slate-900">{right.title}</h3>
                <p className="text-slate-600 text-sm mt-1">{right.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3 text-slate-700">
            ...
            <div className="space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-100 p-4">
                ...
                <p className="text-sm text-slate-600 mt-1">For secure teacher authentication. Google does not share student data.</p>
              </div>

              <div className="rounded-lg border border-slate-200 bg-slate-100 p-4">
                <h3 className="font-semibold text-slate-900">Stripe</h3>
                <p className="text-sm text-slate-600 mt-1">For payment processing. We never see your credit card details.</p>
              </div>

              <div className="rounded-lg border border-slate-200 bg-slate-100 p-4">
                <h3 className="font-semibold text-slate-900">Analytics</h3>
                <p className="text-sm text-slate-600 mt-1">Anonymous, aggregated usage data only. No tracking of individual students.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-orange-200 bg-orange-50 p-6 space-y-3 text-slate-700">
            <p className="font-semibold text-slate-900">Privacy & Data Protection</p>

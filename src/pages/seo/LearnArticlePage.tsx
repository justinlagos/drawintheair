...
const ARTICLES: Record<string, ArticleData> = {
    'hand-tracking-for-kids': {
        ...
        content: (
            <>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>What is Hand Tracking Technology?</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Why it Matters for Child Development</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>How Draw in the Air Supports It</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Activities Parents and Teachers Can Try</h2>
                <ul>
                    <li><strong>Air Tracing:</strong> Go to our <a href="/letter-tracing" style={{ color: '#2E9D68' }}>Letter Tracing</a> section and let your child draw giant letters in the air.</li>
    ...
    'gesture-learning': {
        ...
        content: (
            <>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>What is Gesture-Based Learning?</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Activities Parents and Teachers Can Try</h2>
                <ul>
                    <li><strong>Shape Tracing:</strong> Start with simple activities like <a href="/trace-circle" style={{ color: '#2E9D68' }}>tracing a circle</a> using big arm swings.</li>
    ...
    'drawing-skills-for-children': {
        ...
        content: (
            <>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>The Stages of Drawing Development</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Activities Parents and Teachers Can Try</h2>
                <ul>
                    <li><strong>Free Paint:</strong> Let them explore unguided drawing in our <a href="/app?mode=free" style={{ color: '#2E9D68' }}>Free Paint</a> mode.</li>
                    <li><strong>Shape Practice:</strong> Move to structured shape tracing, like <a href="/trace-square" style={{ color: '#2E9D68' }}>drawing a square</a>.</li>
                </ul>
            </>
        )
    },
    'ai-for-kids': {
        ...
        content: (
            <>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>What is AI, Really?</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>How Hand Tracking Works, Step by Step</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Teaching the Concept in Class</h2>
                ...
                <ul>
                    ...
                    <li>Try our <a href="/trace-a" style={{ color: '#2E9D68' }}>letter tracing activity</a> while discussing how the AI follows the finger</li>
                </ul>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Privacy: What the AI Does NOT Do</h2>
    ...
    'screen-time-alternatives': {
        ...
        content: (
            <>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Not All Screens Are Equal</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>What Makes Gesture Learning Different</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Practical Alternatives to Passive Screen Time</h2>
                <p>Rather than simply reducing screen time, consider redirecting it toward active digital tools. Some ideas:</p>
                <ul>
                    <li>Replace 10 minutes of video with <a href="/activities/bubble-pop" style={{ color: '#2E9D68' }}>Bubble Pop</a>, physical, reflexive, and energising</li>
                    <li>Swap tablet games with <a href="/letter-tracing" style={{ color: '#2E9D68' }}>Letter Tracing</a>, builds the same muscle memory as pencil practice</li>
                    <li>Use <a href="/activities/sort-and-place" style={{ color: '#2E9D68' }}>Sort & Place</a> as a cognitive transition activity between passive and active time</li>
                    <li>Try <a href="/free-paint" style={{ color: '#2E9D68' }}>Free Paint</a> mode for creative, open-ended digital art that replaces scrolling</li>
                </ul>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>The Parent's Role</h2>
    ...
    'early-childhood-motor-skills': {
        ...
        content: (
            <>
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Understanding Motor Skills</h2>
                ...
                <h2 style={{ color: '#1F1B2E', fontSize: '1.6rem', marginTop: '2rem' }}>Activities Parents and Teachers Can Try</h2>
                <ul>
                    <li><strong>Bubble Popping:</strong> Use big swiping motions to <a href="/app?mode=calibration" style={{ color: '#2E9D68' }}>pop bubbles</a>.</li>
                    <li><strong>Number Tracing:</strong> Practice controlled, sweeping gestures by <a href="/trace-number-8" style={{ color: '#2E9D68' }}>tracing big numbers</a>.</li>
                </ul>
            </>
        )
    }
...
export default function LearnArticlePage({ slug }: { slug: string }) {
    ...
    if (!article) {
        return (
            <SeoLayout>
                <div style={{ textAlign: 'center', padding: '100px 20px', color: '#1F1B2E' }}>
                    <h2>Article not found.</h2>
                    <a href="/" style={{ color: '#2E9D68' }}>Return home</a>
                </div>
            </SeoLayout>
        );
    }
        ...
        <SeoLayout>
            ...
            <Section light>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    <h2 style={{ color: '#1F1B2E', fontSize: '1.4rem', fontWeight: 800, marginBottom: 24 }}>Frequently Asked Questions</h2>

...
const ColoursScene = () => (
    <>
        <SkyBase from="#DCEEFF" mid="#EAF7FF" to="#FBF7EE" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            <g transform="translate(1180,140)">
                <circle r="78" fill="#FFC83D" />
                <g stroke="#FFC83D" strokeWidth="6" strokeLinecap="round" opacity="0.7">
            ...
            <g opacity="0.5" transform="translate(720,720)">
                <path d="M -380,0 A 380,380 0 0 1 380,0" fill="none" stroke="#FF9B7E" strokeWidth="22" />
                <path d="M -355,0 A 355,355 0 0 1 355,0" fill="none" stroke="#FF9B7E" strokeWidth="22" />
                <path d="M -330,0 A 330,330 0 0 1 330,0" fill="none" stroke="#FFC83D" strokeWidth="22" />
                <path d="M -305,0 A 305,305 0 0 1 305,0" fill="none" stroke="#5BCE9A" strokeWidth="22" />
                <path d="M -280,0 A 280,280 0 0 1 280,0" fill="none" stroke="#7BB6FF" strokeWidth="22" />
                <path d="M -255,0 A 255,255 0 0 1 255,0" fill="none" stroke="#7350D8" strokeWidth="22" />
            </g>
            <g opacity="0.85">
...
const ShapesScene = () => (
    <>
        <SkyBase from="#C9E5FF" mid="#EAF7FF" to="#F4EFFF" sunX="20%" sunColor="rgba(168, 229, 255, 0.5)" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            {/* Translucent geometric primitives floating in the sky */}
            <g opacity="0.18">
                <circle cx="220" cy="200" r="60" fill="#FF9B7E" />
                <rect x="380" y="120" width="80" height="80" rx="14" fill="#FFC83D" transform="rotate(15 420 160)" />
                <polygon points="900,80 960,200 840,200" fill="#5BCE9A" />
                <polygon points="1180,180 1230,205 1230,260 1180,285 1130,260 1130,205" fill="#9D7DFF" />
                <path d="M 600 240 L 596 280 L 556 280 L 588 304 L 576 344 L 600 320 L 624 344 L 612 304 L 644 280 L 604 280 Z" fill="#7BB6FF" />
                <ellipse cx="1300" cy="340" rx="60" ry="40" fill="#FF9B7E" />
                <path d="M 320 380 L 340 420 L 300 420 Z" fill="#7350D8" />
            </g>
...
const FoodToysScene = () => (
    <>
        <SkyBase from="#FFDCCC" mid="#FBF7EE" to="#FBF7EE" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            {/* Soft sun */}
            <circle cx="1200" cy="160" r="68" fill="#FFC83D" opacity="0.85" />
            ...
            <g transform="translate(80,610)">
                <circle r="22" fill="#F07A5C" />
                <rect x="-2" y="-22" width="4" height="8" fill="#6B4423" />
                <path d="M 2 -18 Q 18 -22 22 -14 Q 14 -10 4 -14 Z" fill="#3FB87F" />
            </g>
            ...
            <rect x="820" y="600" width="48" height="48" rx="8" fill="#FF9B7E" />
            <rect x="900" y="610" width="42" height="42" rx="6" fill="#7BB6FF" />
            <circle cx="1010" cy="620" r="22" fill="#FFC83D" />
            <polygon points="1080,640 1110,580 1140,640" fill="#5BCE9A" />
            <rect x="1180" y="600" width="48" height="48" rx="10" fill="#9D7DFF" />
            <circle cx="1300" cy="618" r="24" fill="#FF9B7E" />
            <rect x="1370" y="610" width="40" height="40" rx="6" fill="#FF9B7E" />
            {/* Window in the upper sky, kitchen vibe */}
            <rect x="60" y="80" width="240" height="180" rx="12" fill="rgba(255,255,255,0.45)"
                  stroke="#C5C0D1" strokeWidth="3" />
            <line x1="180" y1="80" x2="180" y2="260" stroke="#C5C0D1" strokeWidth="3" />
            <line x1="60" y1="170" x2="300" y2="170" stroke="#C5C0D1" strokeWidth="3" />
            ...
            <circle cx="1140" cy="420" r="18" fill="#FF9B7E" />
            <polygon points="1260,420 1240,400 1280,400" fill="#FFC83D" />
...
const AnimalsVehiclesScene = () => (
    <>
        <SkyBase from="#FFD972" mid="#FFEFB8" to="#D2F4E0" sunX="50%" sunColor="rgba(255, 184, 122, 0.5)" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            {/* Sun */}
            <circle cx="720" cy="180" r="70" fill="#FFC83D" />
            ...
            <rect x="720" y="720" width="720" height="6" fill="#3A3450" />
...
const RecycleTrashScene = () => (
    <>
        <SkyBase from="#BEEBFF" mid="#D2F4E0" to="#ECFBF3" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            <circle cx="1200" cy="160" r="60" fill="#FFC83D" opacity="0.9" />
            {/* Park grass */}
            <path d="M0,680 Q360,640 720,670 T1440,660 L1440,900 L0,900 Z" fill="#5BCE9A" />
            <path d="M0,750 Q300,720 720,740 T1440,730 L1440,900 L0,900 Z" fill="#3FB87F" />
            {/* Park trees */}
            {[120, 320, 540, 1020, 1240, 1380].map((x, i) => (
                <g key={i} transform={`translate(${x},650)`}>
                    <rect x="-5" y="0" width="10" height="44" fill="#7A5A3A" />
                    <circle cx="0" cy="-10" r="34" fill="#3FB87F" />
                    <circle cx="-12" cy="-22" r="22" fill="#5BCE9A" />
                    <circle cx="14" cy="-20" r="20" fill="#5BCE9A" />
                </g>
            ))}
            {/* Recycle bin (left, green with arrows) */}
            <g transform="translate(360,540)">
                <rect x="-50" y="0" width="100" height="140" rx="6" fill="#3FB87F" />
                <rect x="-50" y="0" width="100" height="14" rx="6" fill="#2E9D68" />
                <rect x="-58" y="-8" width="116" height="14" rx="4" fill="#2E9D68" />
                {/* Recycling triangle */}
            ...
            <g transform="translate(1080,540)">
                ...
                <rect x="-50" y="0" width="100" height="14" rx="6" fill="#6B6580" />
                <rect x="-58" y="-8" width="116" height="14" rx="4" fill="#6B6580" />
                {/* Trash bag indicator */}
            ...
            {/* Birds */}
            <g stroke="#3A3450" strokeWidth="3" fill="none" strokeLinecap="round" opacity="0.5">
...
const LettersScene = () => (
    <>
        <SkyBase from="#FFF0DC" mid="#FBF7EE" to="#FBF7EE" sunX="50%" sunColor="rgba(255, 200, 100, 0.35)" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            ...
            {/* Books on the shelf */}
            {[
                ['#FF9B7E', 60], ['#FFC83D', 50], ['#5BCE9A', 65], ['#7BB6FF', 55],
                ['#7350D8', 70], ['#FF9B7E', 60], ['#FF9B7E', 50], ['#9D7DFF', 65],
                ['#FF9B7E', 55], ['#5BCE9A', 60], ['#FFC83D', 50], ['#7350D8', 65],
                ['#7BB6FF', 55], ['#FF9B7E', 70], ['#FF9B7E', 50], ['#9D7DFF', 60],
                ['#5BCE9A', 55], ['#FF9B7E', 60], ['#FFC83D', 65], ['#7BB6FF', 50],
            ].map(([color, h], i) => {
                const x = 30 + i * 70;
            ...
            <g fontFamily="Fredoka, system-ui, sans-serif" fontWeight="700" opacity="0.18">
                <text x="180" y="200" fontSize="80" fill="#7350D8">a</text>
                <text x="380" y="160" fontSize="64" fill="#FF9B7E">b</text>
                <text x="640" y="220" fontSize="72" fill="#5BCE9A">c</text>
                <text x="900" y="180" fontSize="68" fill="#7BB6FF">d</text>
                <text x="1140" y="240" fontSize="78" fill="#FF9B7E">e</text>
                <text x="1300" y="180" fontSize="60" fill="#9D7DFF">f</text>
            </g>
            {/* Floating book */}
            <g transform="translate(160,360) rotate(-12)">
                <rect width="80" height="60" rx="3" fill="#FF9B7E" />
                <rect x="2" y="2" width="76" height="56" rx="2" fill="#FFFFFF" />
                <line x1="40" y1="2" x2="40" y2="58" stroke="#3A3450" strokeWidth="1.5" />
                <line x1="10" y1="20" x2="34" y2="20" stroke="#C5C0D1" strokeWidth="1" />
                <line x1="10" y1="32" x2="34" y2="32" stroke="#C5C0D1" strokeWidth="1" />
                <line x1="46" y1="20" x2="70" y2="20" stroke="#C5C0D1" strokeWidth="1" />
                <line x1="46" y1="32" x2="70" y2="32" stroke="#C5C0D1" strokeWidth="1" />
            </g>
            <g transform="translate(1180,400) rotate(8)">
                <rect width="70" height="52" rx="3" fill="#5BCE9A" />
                <rect x="2" y="2" width="66" height="48" rx="2" fill="#FFFFFF" />
                <line x1="35" y1="2" x2="35" y2="50" stroke="#3A3450" strokeWidth="1.5" />
            </g>
        </svg>
    </>
);
...
const NumbersScene = () => (
    <>
        <SkyBase from="#D7E9FF" mid="#EAF7FF" to="#F4EFFF" sunX="80%" sunColor="rgba(108, 63, 164, 0.20)" />
        <svg aria-hidden viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice"
             style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
            ...
            <rect x="700" y="720" width="60" height="14" rx="2" fill="#FFC83D" />
            <rect x="700" y="720" width="60" height="6" rx="2" fill="#FF9B7E" />
            {/* Chalk */}
            <rect x="800" y="722" width="40" height="6" rx="3" fill="#FFFFFF" />
            <rect x="860" y="722" width="35" height="6" rx="3" fill="#FF9B7E" />
            {/* Floating math symbols in the sky */}
            <g fontFamily="Fredoka, system-ui, sans-serif" fontWeight="700" opacity="0.18">
                <text x="220" y="200" fontSize="80" fill="#FF9B7E">+</text>
                <text x="420" y="280" fontSize="72" fill="#7BB6FF">−</text>
                <text x="640" y="160" fontSize="84" fill="#5BCE9A">×</text>
                <text x="900" y="220" fontSize="80" fill="#FFC83D">÷</text>
                <text x="1140" y="180" fontSize="76" fill="#9D7DFF">=</text>
                <text x="1300" y="280" fontSize="64" fill="#FF9B7E">%</text>
            </g>
            {/* Cloud */}
